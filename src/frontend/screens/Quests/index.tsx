...
import { Alert, Background } from '@novaplay/ui'
    ...
    alertComponent = (
      <Alert
        ...
        message={t(
          ...
          'You are currently not logged in, play streak progress will not be tracked. Please login to NovaPlay via the top-right dropdown to track progress.'
        )}
        variant="warning"
      />
    )

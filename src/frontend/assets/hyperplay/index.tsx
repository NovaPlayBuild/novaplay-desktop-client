...
export { ReactComponent as NovaPlayLogoGreen } from './novaplay_logo_green.svg'
export { ReactComponent as NovaPlayLogoRed } from './novaplay_logo_red.svg'
export { ReactComponent as NovaPlayLogoWhite } from './novaplay_logo_white.svg'
